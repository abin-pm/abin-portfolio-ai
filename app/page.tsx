  ...
  return (
    <>
      ...
      <main>
        ...
        <section id="experience"><div className="section-inner"><div className="section-label fade-in">Career Timeline</div><h2 className="section-title fade-in">Work Experience</h2><p className="section-sub fade-in">9+ years across startups, agencies, and enterprise tech giants.</p><div className="exp-timeline"><div className="exp-item fade-in"><div className="exp-dot" /><div className="exp-period">SEP 2024 — PRESENT</div><a className="exp-company" href="https://www.ibm.com/in-en" target="_blank" rel="noopener noreferrer">IBM India Pvt Ltd ↗</a><div className="exp-role">Senior Application Developer (Full Stack &amp; Cloud) · Kochi, India</div><ul className="exp-bullets"><li>Modernized enterprise frontend systems by migrating legacy apps to React.js Micro-Frontend architecture, improving scalability and modular deployments.</li><li>Leveraged AI-assisted tools (Cursor, GitHub Copilot, Claude) to accelerate code generation, debugging, and refactoring across React &amp; Node.js services.</li><li>Stabilized GenAI-generated application components, enforcing enterprise coding standards and microservices best practices.</li><li>Collaborated with US-based stakeholders in Agile/Scrum teams to deliver high-value enterprise features at pace.</li></ul></div><div className="exp-item fade-in"><div className="exp-dot" /><div className="exp-period">SEP 2020 — SEP 2024</div><a className="exp-company" href="https://emvigotech.com/" target="_blank" rel="noopener noreferrer">Emvigo Technologies ↗</a><div className="exp-role">Team Lead / Senior Software Engineer · Kochi, India</div><ul className="exp-bullets"><li>Led end-to-end full stack development using React.js, Next.js, Node.js, and microservices-based architectures.</li><li>Built data-intensive platforms integrating PostgreSQL, MongoDB, Firestore, REST &amp; GraphQL APIs.</li><li>Delivered cloud-ready systems on AWS and GCP with CI/CD pipelines and production monitoring.</li><li>Mentored junior engineers and collaborated with UK &amp; international clients on solution architecture.</li></ul></div><div className="exp-item fade-in"><div className="exp-dot" /><div className="exp-period">JAN 2018 — SEP 2020</div><a className="exp-company" href="https://luminescent.digital/" target="_blank" rel="noopener noreferrer">Luminescent Software ↗</a><div className="exp-role">Software Engineer (Full Stack) · Thiruvananthapuram, India</div><ul className="exp-bullets"><li>Developed responsive SPAs using React.js, Redux, and Next.js with Node.js/Express backends.</li><li>Improved production stability through systematic debugging, performance tuning, and feature delivery.</li></ul></div><div className="exp-item fade-in"><div className="exp-dot" /><div className="exp-period">MAY 2016 — DEC 2017</div><a className="exp-company" href="https://www.ociuz.com/" target="_blank" rel="noopener noreferrer">Ocuiz Technologies ↗</a><div className="exp-role">Software Engineer · Thrissur, India</div><ul className="exp-bullets"><li>Supported full stack development across frontend, backend, and database layers for production web applications.</li><li>Improved system reliability by resolving bugs and optimizing legacy code alongside senior engineers.</li></ul></div></div></div></section>
        <section id="projects"><div className="section-inner"><div className="section-label fade-in">Selected Work</div><h2 className="section-title fade-in">Key Projects</h2><p className="section-sub fade-in">Enterprise-scale platforms shipped for global clients across retail, energy, and SaaS.</p><div className="projects-grid"><div className="project-card fade-in"><a className="project-client" href="https://www.abercrombie.com/shop/am" target="_blank" rel="noopener noreferrer">Abercrombie &amp; Fitch Co. · USA ↗</a><div className="project-name">E-Commerce Frontend Modernization</div><div className="project-desc">Migrated legacy Java-based frontend to a React.js Micro-Frontend architecture. Built the My List (Wishlist) feature, and revamped the Global Config Hub migrating to PrimeReact for consistency across the enterprise e-commerce platform.</div><div className="project-impact">⚡ Parallel deployments · Improved UI scalability · Reduced release friction</div><div className="project-stack"><span className="stack-tag">React.js</span><span className="stack-tag">Micro-Frontend</span><span className="stack-tag">PrimeReact</span><span className="stack-tag">TypeScript</span></div></div><div className="project-card fade-in"><a className="project-client" href="https://www.nationalgridus.com/Default.aspx" target="_blank" rel="noopener noreferrer">National Grid · USA ↗</a><div className="project-name">Enterprise Tracking Application</div><div className="project-desc">Modernized a legacy SAS-based desktop system into a React.js + Node.js web platform using GenAI-assisted code generation as baseline. Refactored AI-generated components to meet enterprise architecture and production reliability standards.</div><div className="project-impact">🏢 Legacy → modern web · Enterprise-grade reliability · GenAI code stabilization</div><div className="project-stack"><span className="stack-tag">React.js</span><span className="stack-tag">Node.js</span><span className="stack-tag">.NET Core</span><span className="stack-tag">GenAI</span></div></div><div className="project-card fade-in"><a className="project-client" href="http://paragon-energy.co.uk/" target="_blank" rel="noopener noreferrer">Paragon Energy · UK ↗</a><div className="project-name">Smart Meter Asset Management Platform</div><div className="project-desc">Built a large-scale energy asset management platform managing 200,000+ smart meters. Led a frontend team of 3 engineers. Workflow automation dramatically cut operational turnaround times, demonstrating measurable business impact.</div><div className="project-impact">🚀 96 hours → 2 hours operational turnaround · 200k+ meters managed</div><div className="project-stack"><span className="stack-tag">React.js</span><span className="stack-tag">Node.js</span><span className="stack-tag">MySQL</span><span className="stack-tag">Elasticsearch</span><span className="stack-tag">AWS</span></div></div><div className="project-card fade-in"><a className="project-client" href="https://www.refinu.com/" target="_blank" rel="noopener noreferrer">Refinu · SaaS ↗</a><div className="project-name">Personality Assessment Platform</div><div className="project-desc">Architected a serverless microservices platform on Google Cloud. Implemented personalized assessment workflows, push notification system for engagement, and led requirement discussions end-to-end with stakeholders.</div><div className="project-impact">☁️ Serverless architecture · Push notification system · Full ownership from design to deploy</div><div className="project-stack"><span className="stack-tag">React</span><span className="stack-tag">Node.js</span><span className="stack-tag">Firestore</span><span className="stack-tag">GCP</span><span className="stack-tag">Cloud Functions</span></div></div></div></div></section>
