...
const personSchema = {
  ...
  sameAs: ['https://www.linkedin.com/in/abin-p-m-/', 'https://github.com/abin-pm'],
  knowsAbout: [
    'React.js',
    'Next.js',
    'Node.js',
      ...
      <main>
        <section id="hero" className="hero">
          ...
          <div className="hero-content">
            ...
            <div className="hero-ctas"><a href="#projects" className="btn-primary"><span>View Work</span><span>→</span></a><a href="#contact" className="btn-secondary"><span>Get in Touch</span></a><a href="https://www.linkedin.com/in/abin-p-m-/" target="_blank" rel="noopener" className="btn-secondary">LinkedIn ↗</a><a href="https://github.com/abin-pm" target="_blank" rel="noopener" className="btn-secondary">GitHub ↗</a></div>
        ...
        <section id="skills"><div className="section-inner"><div className="section-label fade-in">Technical Arsenal</div><h2 className="section-title fade-in">What I Build With</h2><p className="section-sub fade-in">A full-spectrum stack from pixel-perfect UIs to cloud-native distributed backends.</p><div className="skills-grid fade-in"><div className="skill-card skill-card-frontend"><div className="skill-card-icon">⚡</div><div className="skill-card-title">Frontend</div><div className="skill-tags"><span className="tag">React.js</span><span className="tag">Next.js</span><span className="tag">TypeScript</span><span className="tag">Redux</span><span className="tag">Micro-Frontend</span><span className="tag">Tailwind CSS</span><span className="tag">HTML5</span><span className="tag">CSS3</span></div></div><div className="skill-card skill-card-backend"><div className="skill-card-icon">🔧</div><div className="skill-card-title">Backend &amp; APIs</div><div className="skill-tags"><span className="tag">Node.js</span><span className="tag">Express.js</span><span className="tag">Microservices</span><span className="tag">REST APIs</span><span className="tag">GraphQL</span><span className="tag">C#</span><span className="tag">.NET Core</span></div></div><div className="skill-card skill-card-database"><div className="skill-card-icon">🗄️</div><div className="skill-card-title">Databases</div><div className="skill-tags"><span className="tag">MongoDB</span><span className="tag">PostgreSQL</span><span className="tag">MySQL</span><span className="tag">Firestore</span><span className="tag">Redis</span><span className="tag">Elasticsearch</span><span className="tag">Kafka</span><span className="tag">RabbitMQ</span></div></div><div className="skill-card skill-card-cloud"><div className="skill-card-icon">☁️</div><div className="skill-card-title">Cloud &amp; DevOps</div><div className="skill-tags"><span className="tag">AWS</span><span className="tag">GCP</span><span className="tag">Azure</span><span className="tag">Docker</span><span className="tag">Kubernetes</span><span className="tag">CI/CD</span><span className="tag">Serverless</span></div></div><div className="skill-card skill-card-ai"><div className="skill-card-icon">🤖</div><div className="skill-card-title">AI-Assisted Development</div><div className="skill-tags"><span className="tag">Cursor AI</span><span className="tag">GitHub Copilot</span><span className="tag">Claude</span><span className="tag">OpenAI Codex</span><span className="tag">LLM Integration</span><span className="tag">GenAI Code Review</span></div></div><div className="skill-card skill-card-testing"><div className="skill-card-icon">🧪</div><div className="skill-card-title">Testing &amp; Tooling</div><div className="skill-tags"><span className="tag">Jest</span><span className="tag">Vitest</span><span className="tag">ESLint</span><span className="tag">GitHub</span><span className="tag">Bitbucket</span><span className="tag">Jira</span><span className="tag">Agile/Scrum</span></div></div></div></div></section>
